...
//
//// XA Start
//func (s *DB) XAStart(xid string) (c *DB) {
//	c = s.clone()
//	c.dialect.SetDB(s.DB())
//	//c = s.New()
//	if _, ok := s.Get("xid:xa"); ok {
//		s.AddError(ErrCantXAStartTransaction)
//	}
//	if db, ok := c.db.(SQLCommon); ok && db != nil {
//		if _, err := c.db.Exec(fmt.Sprintf("xa start '%s'", xid)); err != nil {
//			c.AddError(err)
//		} else {
//			c = s.Set("xid:xa", xid)
//		}
...
//	xid, ok := s.Get("xid:xa")
//	if !ok {
//		s.AddError(ErrXAMissingXID)
//	}
//	fmt.Println("xa end", xid)
//	if db, ok := s.db.(SQLCommon); ok && db != nil {
//		if _, err := db.Exec(fmt.Sprintf("xa end '%s'", xid)); err != nil {
//			s.AddError(err)
//			return s
//		}
//	} else {
//		s.AddError(ErrInvalidXATransaction)
//	}
//	return s
//}
//
//func (s *DB) XAPrepare() *DB {
//	xid, ok := s.Get("xid:xa")
//	if !ok {
//		s.AddError(ErrXAMissingXID)
//	}
//	if db, ok := s.db.(SQLCommon); ok && db != nil {
//		if _, err := db.Exec(fmt.Sprintf("xa prepare '%s'", xid)); err != nil {
//			s.AddError(err)
//			return s
//		}
//	} else {
...
//}
//
//func (s *DB) XACommit() *DB {
//	xid, ok := s.Get("xid:xa")
//	if !ok {
//		s.AddError(ErrXAMissingXID)
//	}
//	if db, ok := s.db.(SQLCommon); ok && db != nil {
//		if _, err := db.Exec(fmt.Sprintf("xa commit '%s'", xid)); err != nil {
//			s.AddError(err)
//			return s
//		}
//	} else {
...
//}
//
//func (s *DB) XARollback() *DB {
//	xid, ok := s.Get("xid:xa")
//	if !ok {
//		s.AddError(ErrXAMissingXID)
//	}
//	if db, ok := s.db.(SQLCommon); ok && db != nil {
//		if _, err := db.Exec(fmt.Sprintf("xa rollback '%s'", xid)); err != nil {
//			s.AddError(err)
//			return s
//		}
//	} else {
